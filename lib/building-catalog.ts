...
export const BUILDING_CATALOG: BuildingCatalogEntry[] = [
  ...
  // Coming-soon entries below. Phase 1 keeps them listed with `mvpActive:false`
  // so the catalog teaches the player what's on the horizon (backlog 1.6.2).
  {
    id: "bank-lokalny",
    category: "civic",
    tier: 3,
    ...
    teasers: {
      pl: "Wkrótce — odblokuje preferowany kredyt (5% APR vs 8%).",
      uk: "Скоро — відкриє пільговий кредит (5% APR vs 8%).",
      cs: "Brzy — odemkne zvýhodněný úvěr (5% APR vs 8%).",
      en: "Coming soon — unlocks the Preferred mortgage (5% APR vs 8%).",
    },
    mvpActive: false,
  },
  {
    ...
    teasers: {
      pl: "Wkrótce — pierwszy producent szkła, 4 🪟/h.",
      uk: "Скоро — перший виробник скла, 4 🪟/год.",
      cs: "Brzy — první producent skla, 4 🪟/h.",
      en: "Coming soon — first glass producer, 4 🪟/h.",
    },
    mvpActive: false,
  },
  {
    ...
    teasers: {
      pl: "Wkrótce — +20% 🪙 z quiz / true-false.",
      uk: "Скоро — +20% 🪙 з квіз / true-false.",
      cs: "Brzy — +20% 🪙 z kvíz / true-false.",
      en: "Coming soon — +20% 🪙 on quiz / true-false yields.",
    },
    mvpActive: false,
  },
  {
    ...
    teasers: {
      pl: "Wkrótce — 3 🔩/h, potrzebne do budynków T5+.",
      uk: "Скоро — 3 🔩/год, потрібна для будівель T5+.",
      cs: "Brzy — 3 🔩/h, potřebná pro budovy T5+.",
      en: "Coming soon — 3 🔩/h, needed for tier-5+ buildings.",
    },
    mvpActive: false,
  },
  {
    ...
    teasers: {
      pl: "Wkrótce — 12 ⚡ + 1 💵/h, tier 5.",
      uk: "Скоро — 12 ⚡ + 1 💵/год, tier 5.",
      cs: "Brzy — 12 ⚡ + 1 💵/h, tier 5.",
      en: "Coming soon — 12 ⚡ + 1 💵/h, tier 5.",
    },
    mvpActive: false,
  },
  {
    ...
    teasers: {
      pl: "Wkrótce — 4 💾 + 8 💵/h, tier 6.",
      uk: "Скоро — 4 💾 + 8 💵/год, tier 6.",
      cs: "Brzy — 4 💾 + 8 💵/h, tier 6.",
      en: "Coming soon — 4 💾 + 8 💵/h, tier 6.",
    },
    mvpActive: false,
  },
  {
    ...
    teasers: {
      pl: "Wkrótce — +5% wszystkich yieldów. Katowicki landmark.",
      uk: "Скоро — +5% усіх yield. Катовіцький landmark.",
      cs: "Brzy — +5% všech yieldů. Katovický landmark.",
      en: "Coming soon — +5% on all yields. Katowice landmark.",
    },
    mvpActive: false,
  },
];
