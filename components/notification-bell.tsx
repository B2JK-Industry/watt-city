  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        onClick={toggle}
        title={labels.bell}
        className="relative w-8 h-8 flex items-center justify-center border border-[var(--line)] bg-[var(--surface)] rounded"
      >
      ...
      {open && (
        <div
          ...
          className="absolute right-0 top-full mt-2 z-40 w-[min(95vw,22rem)] max-w-[calc(100vw-1rem)] card p-2 bg-[var(--surface)] border border-[var(--line)]"
        >
          <header className="flex items-center justify-between px-2 py-1 text-xs text-[var(--ink-muted)] border-b border-[var(--line)] mb-1">
