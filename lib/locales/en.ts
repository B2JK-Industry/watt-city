...
const en: typeof plDict = {
  faq: {
    ...
    intro: "Short answers to the most common questions about Watt City. Still unclear? Write to /kontakt.",
    items: [
      {
        q: "How does Watt City work?",
        a: "Play mini-games, earn Watts (XP). Every game adds a building to your city — from a small house to Varso Tower. Every day 0-3 fresh AI mini-games drop (top 3 stays in your profile).",
      },
      {
        q: "Is this real money?",
        a: "No. Everything (Watts, loans, buildings, mortgages) exists only inside the game. We don't take payments — it's pure education.",
      },
      {
        q: "I'm under 16 — can I play?",
        a: "Yes, with parental consent. At registration we ask for a parent's email per GDPR-K. Without consent the account stays in restricted mode.",
      },
      {
        q: "How do you protect my data?",
        a: "We collect the minimum: nickname, password hash, birth year, game scores. No analytics, no tracking, no ads. EU hosting (Frankfurt). Full details: /ochrana-sukromia.",
      },
      {
        q: "Can I play without an account?",
        a: "Yes — pick any game from /games (e.g. Finance quiz) and play in demo mode. The score won't save to the leaderboard but you'll feel how it works.",
      },
      {
        q: "What is PKO XP: Gaming?",
        a: "Partnership with PKO Bank Polski under ETHSilesia 2026. PKO funds the educational platform's development; the bank has no access to your data or game logs.",
      },
    ],
    contactCta: "Something else? Write to",
    contactLinkLabel: "Contact",
  },
  kontakt: {
    title: "Contact",
    intro: "Got a question, found a bug, want to invite the platform to your school? Write us — we reply within 2 business days.",
    nameLabel: "Name",
    emailLabel: "E-mail",
    topicLabel: "Topic",
    ...
    topicBug: "Bug report",
    topicSchool: "School / classroom",
    topicPress: "Press / media",
    topicPrivacy: "Privacy / data",
    submit: "Send",
    submitting: "Sending…",
    successTitle: "Thanks!",
    successBody: "Your message landed. We'll reply within 2 business days.",
    errorRate: "Too many tries. Wait a moment.",
    errorGeneric: "Something went wrong. Try again.",
    schoolLabel: "School name",
    schoolNamePlaceholder: "e.g. Riverside High School",
  },
  aiHub: {
    title: "Today's AI mini-games",
    body: "Every day 0-3 fresh mini-games generated by Claude. Each expires at its scheduled time — top 3 medals stay in your profile.",
    emptyTitle: "Pipeline rotating",
    emptyBody: "Today's first game lands at 09:00 UTC.",
    rotationHint: "Rotation: 1 / 6 / 24 h (fast / medium / slow).",
  },
  consent: {
